...
export class HeightService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/heights', 'babyprofile');
  ...
  protected convertDateFromClient(height: IHeight): IHeight {
    return Object.assign({}, height, {
      date: height.date?.isValid() ? height.date.format(DATE_FORMAT) : undefined,
    });
  }
