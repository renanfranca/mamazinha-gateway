...
export class WeightService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/weights', 'babyprofile');
  ...
  protected convertDateFromClient(weight: IWeight): IWeight {
    return Object.assign({}, weight, {
      date: weight.date?.isValid() ? weight.date.format(DATE_FORMAT) : undefined,
    });
  }
